...
<body style="font-family: 'Oswald', sans-serif;">
        ...
        <div class="navbar-nav">
            ...
            <div id="sidebar" class="sidebar margin_left_menu imagen_fondo_menu">
                <div class="row justify-content-center">
                    <img src="https://elianacelis.files.wordpress.com/2013/05/asa.jpg" width="20%" class="width_tornillo_menu" alt="">
                </div>
    ...
    <!--header-->
    <header>
        <div class="menu d-none d-md-block bg-light">
            ...
            <a href="index2.php?p=principal" class="text-dark">Lo ultimo</a>

            <a href="index2.php?p=productos" class="text-dark">Productos</a>

            <a href="index2.php?p=ofertas" class="text-dark">Ofertas</a>
            <?php
		if(isset($_SESSION['id_cliente'])){
        ?>

            <a href="index2.php?p=carrito" class="text-dark">Carrito</a>

            <a href="index2.php?p=miscompras" class="text-dark">Mis Compras</a>
            <?php
		}else{
            ?>

            <div style="position: absolute; right: 1rem; top:1rem">
                <a href="index2.php?p=login" class="text-dark">Iniciar Sesion</a>

                <a href="index2.php?p=registro" class="text-dark">Registrate</a>
            </div>
            <?php
		}
		?>
		...
		?>
            <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle dropdown_cerrar_sesion" type="button"
                    id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Bienvenido <?=nombre_cliente($_SESSION['id_cliente'])?>
                </button>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 9%;
position: absolute;
transform: translate3d(1701px, 6px, 0px);
top: 0px;
left: 0px;
