...
<div class="scrollmenu">
	...
	while($r=mysqli_fetch_array($s)){
        ...
        <tr>
            ...
            <td><?=fecha($r['fecha'])?></td>
            <td><a style="color:#333" target="_blank" href="../comprobantes/<?=$r['comprobante']?>">Ver Comprobante <i
            ...
            <td>
				...
				if($r['estado']==0){
					?>
                <a style="color:#333" href="?p=pagos&aceptar=<?=$r['id']?>&id_compra=<?=$r['id_compra']?>"
                    title="Verificar y aceptar pago"><i class="fa fa-check"></i></a>
                <?php
				}
				?>
                <a style="color:#333" href="?p=ver_compra&id=<?=$r['id_compra']?>"><i class="fa fa-eye"
                        title="Ver Compra"></i></a>
            </td>
        </tr>
        <?php
	}
	...
	while($r=mysqli_fetch_array($s)){
        ...
        <tr>
            ...
            <td>
				...
				if($r['estado']==0){
					?>
                <a style="color:#333" href="?p=pagos&aceptar=<?=$r['id']?>" title="Verificar y aceptar pago"><i
